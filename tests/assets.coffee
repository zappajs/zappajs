...
@tests =
  ...
  css: (t) ->
    ...
    c.get '/index.css', (err, res) ->
      ...
      t.equal 2, res.headers['content-type'], 'text/css; charset=utf-8'
  ...
  stylus: (t) ->
    ...
    c = t.client(zapp.server)
    c.get '/index.css', (err, res) ->
      t.equal 'header', res.headers['content-type'], 'text/css; charset=utf-8'
  ...
  jquery: (t) ->
    ...
    c = t.client(zapp.server)
    c.get '/zappa/jquery.js', (err, res) ->
      t.equal 'content-type', res.headers['content-type'], 'application/javascript; charset=utf-8'
      t.equal 'length', res.headers['content-length'], '96459'
      t.equal 'body-length', res.body.length, 96459
  ...
  sammy: (t) ->
    ...
    c.get '/zappa/sammy.js', (err, res) ->
      ...
      t.equal 'body-length', res.body.length, 18941
